# Download air quality data from UBA
...
for (sid in stations){
  starttime = Sys.time()
  tryCatch({
    URL <- paste0("https://www.umweltbundesamt.de/api/air_data/v2/airquality/csv?date_from=2016-01-01&time_from=1&date_to=2020-04-06&time_to=24&station=",sid,"&lang=de")
